...
type channelBuilder struct {
	...
	blocks []*types.Block
	// latestL1Origin is the latest L1 block for from the L2 blocks that have been added to the channel
...
func (c *channelBuilder) AddBlock(block *types.Block) (*derive.L1BlockInfo, error) {
	...
	if c.latestL1Origin == nil || l1info.Number > c.latestL1Origin.Number {
